...
import { getPmt, getTl, getMd, getps } from "@/api/myIncentive";
...
export default {
  ...
  data() {
    return {
      topBarTitle: this.$t("pmt.incentive.PSIncentive"),
  ...
  methods: {
    ...
    onConfirm_Date(value) {
      ...
      var params = {
        ...
        month: this.formatNumber(value.getMonth() + 1),
      };
    ...
    getLocationDate() {
      ...
      this.onConfirm_Date(
        new Date(nowDateLocation.year, nowDateLocation.month)
      );
    },
    formatNumber(n) {
      n = n.toString();

                ...
                <van-col span="24">
                  ...
                  <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
                    ...
                    >
                      <div
                        class="item"
                        v-for="(item, index) in this.formData.items[0].slablist"
                        :key="index"
                      >
                        <!-- ITEM BEGIN -->
          ...
          <div class="info">
            <div class="form-group">
              <van-row class="body-row" style="padding-left: 15px">
                ...
                <van-col span="22">
                  <van-field
                    :label="this.$t('pmt.incentive.Productdisplayasguideline')"
                    input-align="left"
                    label-width="auto"
                    :colon="true"
                  >
              ...
              <van-row class="body-row">
                <van-col span="24">
                  <van-field
                    :label="
                      this.$t('pmt.incentive.ActualProductdisplayasguideline')
                    "
                    input-align="left"
                    label-width="auto"
                    :colon="true"
            ...
            <div class="form-group">
              <van-row class="body-row" style="padding-left: 15px">
                ...
                <van-col span="22">
                  ...
                  >
                    <template #input>
                      <span v-text="formData.items[3].target"></span>
                    </template>
                  </van-field>
                </van-col>
              </van-row>
          ...
          <div class="info">
            <div class="form-group">
              <van-row class="body-row" style="padding-left: 15px">
                ...
                <van-col span="22">
                  <van-field
                    :label="this.$t('pmt.incentive.Report')"
                    input-align="left"
                    label-width="auto"
                    :colon="true"
                  >
              ...
              <van-row class="body-row">
                <van-col span="24">
                  <van-field
                    :label="this.$t('pmt.incentive.Actual Report')"
                    input-align="left"
                    label-width="auto"
                    :colon="true"
                  >
                    <template #input>
                      <span v-text="formData.items[4].mtd"></span>
                    </template>
                  </van-field>
                </van-col>
                <van-col span="24">
...
import { getPmt, getTl, getMd, getmetl } from "@/api/myIncentive";
...
export default {
  ...
  data() {
    return {
      topBarTitle: this.$t("pmt.incentive.METLIncentive"),
  ...
  methods: {
    ...
    onConfirm_Date(value) {
      this.selectDate =
        value.getFullYear() + "-" + this.formatNumber(value.getMonth() + 1);

                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th>
                        <span>{{ this.$t("pmt.overtimeList.Date") }}</span>
                      </th>
                      <th>
                        <span>{{ this.$t("pmt.overtimeList.Overtime") }}</span>
                      </th>
                      <th>
                        <span>{{
                          this.$t("pmt.overtimeList.OvertimeReason")
                        }}</span>
                      </th>
                    </tr>
                  </thead>
...
export default {
  ...
  data() {
    return {
      topBarTitle: this.$t("pmt.attendant.listOverTime"),

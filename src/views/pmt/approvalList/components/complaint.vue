        ...
        <div class="info">
          <div class="form-group">
            <div class="">
              <van-field
                class="card-title"
                :label="this.$t('pmt.complaint.ComplaintRetailCode')"
                input-align="right"
              ...
              >
                <template #label>
                  ...
                  ><span
                    v-text="$t('pmt.complaint.ComplaintRetailCode')"
                  ></span>
                </template>
                <template #input>
          ...
          <div class="form-group">
            <div class="">
              <van-field
                class="card-title"
                :label="this.$t('pmt.complaint.OriginalRetailCode')"
                input-align="right"
                label-class="card-lable"
                label-width="auto"
                :colon="true"
              >
                <template #label>
                  ...
                  ><span
                    v-text="$t('pmt.complaint.OriginalRetailCode')"
                  ></span>
                </template>
                <template #input>
                  <span v-text="formData.retail_original.new_retail_code"></span>
                </template>
              </van-field>
              <van-field
                :label="this.$t('pmt.complaint.Photo')"
              ...
              >
                <template #input>
                  <span v-text="formData.retail_original.new_shop_name"></span>
                </template>
              </van-field>
              <van-field
                :label="this.$t('pmt.complaint.InvoiceCode')"
              ...
              >
                <template #input>
                  <span
                    v-text="formData.retail_original.new_invoice_code"
                  ></span>
                </template>
              </van-field>
              <van-field
              ...
              >
                <template #input>
                  <span
                    v-text="formData.retail_original.new_payment_name"
                  ></span>
                </template>
              </van-field>
            </div>
            <div class="form-group">
              ...
              >
                <template #input>
                  <span v-text="formData.retail_original.new_voucher"></span>
                </template>
              </van-field>
            </div>
          </div>
            ...
            <div class="applyAbsence-form-group">
              ...
              >
                <van-field
                  ...
                  @click="showDatePicker = true"
                  :colon="true"
                  v-model="formData.retail_original.new_consumer_name"
                />
                <van-field
                  required
                  readonly
                  ...
                  @click="showTimePicker = true"
                  :colon="true"
                  v-model="formData.retail_original.new_consumer_mobile"
                >
                </van-field>
                <van-field
                  required
                  ...
                  label-width="3.7rem"
                  :colon="true"
                  v-model="formData.retail_original.new_consumer_address"
                >
                </van-field>
              </van-form>
            </div>
            ...
            <div class="applyAbsence-form-group">
              ...
              >
                <van-field
                  ...
                  @click="showDatePicker = true"
                  :colon="true"
                  v-model="formData.retail_original.new_dealer_name"
                />
                <van-field
                  required
                  readonly
                  ...
                  label-width="3.7rem"
                  :colon="true"
                  v-model="formData.retail_original.new_user_name"
                >
                </van-field>
                <van-field
                  required
                  ...
                  label-width="3.7rem"
                  :colon="true"
                  v-model="formData.retail_original.new_created_on"
                >
                </van-field>
                <van-field
                  required
                  ...
                  label-width="3.7rem"
                  :colon="true"
                  v-model="formData.retail_original.new_operator_type_name"
                >
                </van-field>
                <van-field
                  required
                  ...
                  label-width="3.7rem"
                  :colon="true"
                  v-model="formData.retail_original.new_approve_status_name"
                >
                </van-field>
              </van-form>
            </div>
            ...
            <div class="applyAbsence-form-group">
              ...
              >
                <van-field
                  required
                  readonly
                  :label="this.$t('pmt.complaint.ComplaintTotalSO')"
                  input-align="right"
                  label-width="3.7rem"
                  :colon="true"
                  v-model="
                    formData.retail_original.new_complaint_total_sell_out
                  "
                />
                <van-field
                  required
                  readonly
                  :label="this.$t('pmt.complaint.ComplaintKeySO')"
                  input-align="right"
                  label-width="3.7rem"
                  :colon="true"
                  v-model="formData.retail_original.new_complaint_key_sell_out"
                >
                </van-field>
              </van-form>
            </div>
...
export default {
  ...
  data() {
    return {
      topBarTitle: this.$t("pmt.complaint.topBarTitle"),
      ...
      getapprovedetail(data)
        .then((res) => {
          if (res.success) {
            ...
            this.retailPhotoList.push({
              new_download_url:
                this.formData.retail_original.new_invoice_imageurl,
              new_keyword: "complaint",
              new_description: "complaint",
              new_type: 1,
              new_filename: "complaint",

  ...
  <div>
    ...
    <van-form @submit="onSubmit" class="">
      <div class="infog-card form-group policy">
        <van-tabs type="card">
          <van-tab :title="this.$t('pmt.policy.tabsPsTitle')">
              ...
              >
                <template #input>
                  <span
                    ...
                    v-text="psFormData.totalestimatedsoincentive"
                  ></span>
                </template>
              </van-field>
            </div>
            ...
            <div class="infog-card form-group">
              <van-field
                readonly
                v-model="psFormData.items[0].target"
              ...
              <van-row>
                <van-list v-model="loading" :finished="finished">
                  <div
                    class="item"
                    v-for="(item, index) in psFormData.items[0].slablist"
                    :key="index"
                  >
              ...
              <van-field
                readonly
                v-model="psFormData.items[0].mtd"
              ...
              <van-field
                readonly
                v-model="psFormData.items[0].estimatedincentive"
            ...
            <div class="infog-card form-group">
              <van-field
                readonly
                v-model="psFormData.items[1].target"
              ...
              <van-row>
                <van-list v-model="loading" :finished="finished">
                  <div
                    class="item"
                    v-for="(item, index) in psFormData.items[1].slablist"
                    :key="index"
                  >
                    <van-row type="flex" justify="center">
                      <van-col span="12" class="list-body">
              ...
              <van-field
                readonly
                v-model="psFormData.items[1].mtd"
              ...
              <van-field
                readonly
                v-model="psFormData.items[1].estimatedincentive"
                :label="this.$t('home.policy.tlFormMtdMhSellout')"
                input-align="right"
                label-width="150px"
              />
...
import { getPS } from "@/api/policyScheme";
export default {
  name: "psPolicyScheme",
  components: {
    TopBar,
  ...
  data() {
    return {
      topBarTitle: this.$t("pmt.policy.tabsPsTitle"),
        ...
        items: [
          {
            ...
            slablist: [],
            target: "0",
            targettype: "Total Sell-Out Target",
          },
          {
            estimatedincentive: "0",
            mtd: "0",

  ...
  <div>
    ...
    <van-form @submit="onSubmit" class="">
      <div class="infog-card form-group policy">
        <van-tabs type="card">
          <van-tab :title="this.$t('pmt.policy.tabsMetlTitle')">
              ...
              >
                <template #input>
                  <span
                    ...
                    v-text="meFormData.totalestimatedsoincentive"
                  ></span>
                </template>
              </van-field>
            </div>
            ...
            <div class="infog-card form-group">
              <van-field
                readonly
                v-model="meFormData.items[0].target"
              ...
              <van-row>
                <van-list v-model="loading" :finished="finished" @load="onLoad">
                  <div
                    class="item"
                    v-for="(item, index) in meFormData.items[0].slablist"
                    :key="index"
                  >
              ...
              <van-field
                readonly
                v-model="meFormData.items[0].mtd"
              ...
              <van-field
                readonly
                v-model="meFormData.items[0].estimatedincentive"
            ...
            <div class="infog-card form-group">
              <van-field
                readonly
                v-model="meFormData.items[1].target"
              ...
              <van-row>
                <van-list v-model="loading" :finished="finished" @load="onLoad">
                  <div
                    class="item"
                    v-for="(item, index) in meFormData.items[1].slablist"
                    :key="index"
                  >
                    <van-row type="flex" justify="center">
                      <van-col span="12" class="list-body">
            ...
            <div class="infog-card form-group">
              <van-field
                readonly
                v-model="meFormData.items[2].target"
              ...
              <van-row>
                <van-list v-model="loading" :finished="finished" @load="onLoad">
                  <div
                    class="item"
                    v-for="(item, index) in meFormData.items[2].slablist"
                    :key="index"
                  >
                    <van-row type="flex" justify="center">
                      <van-col span="12" class="list-body">
              ...
              <van-field
                readonly
                v-model="meFormData.items[2].mtd"
              ...
              <van-field
                readonly
                v-model="meFormData.items[2].estimatedincentive"
                :label="this.$t('home.policy.tlFormMtdMhSellout')"
                input-align="right"
                label-width="150px"
              />
            ...
            <div class="infog-card form-group">
              ...
              <van-row>
                <van-list v-model="loading" :finished="finished" @load="onLoad">
                  <div
                    class="item"
                    v-for="(item, index) in meFormData.items[3].slablist"
                    :key="index"
                  >
                    <van-row type="flex" justify="center">
                      <van-col span="12" class="list-body">
...
import { getPS,postGetme } from "@/api/policyScheme";
export default {
  name: "mePolicyScheme",
  components: {
    TopBar,
  ...
  data() {
    return {
      topBarTitle: this.$t("pmt.policy.tabsMetlTitle"),
